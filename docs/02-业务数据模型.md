...
- `0003_followup_confirmation.sql` 已实现来源、草稿/修订、正式跟进、更正、参与人/商机关联、事实/证据、幂等、审计、领域事件和 Outbox 的物理基线；持久化 Store、API 与 Web 确认闭环仍在实施；
...
- `0004`–`0006` 尚未实现；`0003` 目前只完成 schema 和数据库不变量，跟进确认 Store/API/Web、分析动作、通知投递、周报问数和导入不能误称已经落地。
